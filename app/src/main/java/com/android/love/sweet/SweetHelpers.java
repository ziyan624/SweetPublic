 ...
 */
public final class SweetHelpers {
	private SweetHelpers() {}
	...
	public static Class<?> findClass(String className, ClassLoader classLoader) {
		if (classLoader == null)
			classLoader = SweetBridge.BOOTCLASSLOADER;
		try {
	 ...
	 * for details.
	 */
	public static WC_MethodCook.UnCook findAndHookMethod(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
		if (parameterTypesAndCallback.length == 0 || !(parameterTypesAndCallback[parameterTypesAndCallback.length-1] instanceof WC_MethodCook))
			throw new IllegalArgumentException("no callback defined");

		WC_MethodCook callback = (WC_MethodCook) parameterTypesAndCallback[parameterTypesAndCallback.length-1];
		Method m = findMethodExact(clazz, methodName, getParameterClasses(clazz.getClassLoader(), parameterTypesAndCallback));

		return SweetBridge.hookMethod(m, callback);
	}
	 ...
	 * an anonymous subclass of {@link WC_MethodCook} or {@link WC_MethodReplacement}.
	 *
	 * <p><b>Example</b>
	 ...
	 * findAndHookMethod("com.example.SomeClass", lpparam.classLoader, String.class, int.class, "com.example.MyClass", new WC_MethodCook() {
	 *   &#64;Override
	 ...
	 */
	public static WC_MethodCook.UnCook findAndHookMethod(String className, ClassLoader classLoader, String methodName, Object... parameterTypesAndCallback) {
	...
	private static Class<?>[] getParameterClasses(ClassLoader classLoader, Object[] parameterTypesAndCallback) {
		...
		for (int i = parameterTypesAndCallback.length - 1; i >= 0; i--) {
			...
			if (type instanceof WC_MethodCook)
				continue;
	 ...
	 * for details.
	 */
	public static WC_MethodCook.UnCook findAndHookConstructor(Class<?> clazz, Object... parameterTypesAndCallback) {
		if (parameterTypesAndCallback.length == 0 || !(parameterTypesAndCallback[parameterTypesAndCallback.length-1] instanceof WC_MethodCook))
			throw new IllegalArgumentException("no callback defined");
	 ...
	 * for details.
	 */
	public static WC_MethodCook.UnCook findAndHookConstructor(String className, ClassLoader classLoader, Object... parameterTypesAndCallback) {
