...
/**
 * A special case of {@link WC_MethodCook} which completely replaces the original method.
 */
public abstract class WC_MethodReplacement extends WC_MethodCook {
	/**
	 * Creates a new callback with default priority.
	 */
	public WC_MethodReplacement() {
		super();
	}
	 ...
	 */
	public WC_MethodReplacement(int priority) {
		super(priority);
	}
	 ...
	 */
	public static final WC_MethodReplacement DO_NOTHING = new WC_MethodReplacement(PRIORITY_HIGHEST*2) {
		@Override
	 ...
	 */
	public static WC_MethodReplacement returnConstant(final Object result) {
	 ...
	 * @param result The value that should be returned to callers of the hooked method.
	 */
	public static WC_MethodReplacement returnConstant(int priority, final Object result) {
		return new WC_MethodReplacement(priority) {
			@Override
			protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
				return result;
			}
