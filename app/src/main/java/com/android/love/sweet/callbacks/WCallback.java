 ...
 */
public abstract class WCallback implements Comparable<WCallback> {
	/**
	...
	public static abstract class Param {
		...
		/** @hide */
		protected Param(CopyOnWriteSortedSet<? extends WCallback> callbacks) {
	...
	public static void callAll(Param param) {
		...
		for (int i = 0; i < param.callbacks.length; i++) {
			try {
				((WCallback) param.callbacks[i]).call(param);
	...
	/** @hide */
	@Override
	public int compareTo(WCallback other) {
		if (this == other)
			return 0;
