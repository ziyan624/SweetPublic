 ...
 */
public interface ISweetCookInitPackageResources extends ISweetMod {
	/**
	...
	/** @hide */
	final class Wrapper extends WC_InitPackageResources {
		private final ISweetCookInitPackageResources instance;
		public Wrapper(ISweetCookInitPackageResources instance) {
